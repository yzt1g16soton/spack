        ...
        def _decorator(decorated_function):
            ...
            def _wrapper(*args, **kwargs):
                ...
                if DirectiveMeta._when_constraints_from_context:
                    ...
                    when_spec_from_context = " ".join(DirectiveMeta._when_constraints_from_context)
...
@directive("variants")
def variant(name, default=None, description="", values=None, multi=None, validator=None):
