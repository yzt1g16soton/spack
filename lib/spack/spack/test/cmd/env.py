...
def test_env_activate_view_fails(tmpdir, mock_stage, mock_fetch, install_mockery, env_deactivate):
...
def test_env_activate_default_view_root_unconditional(env_deactivate, mutable_mock_env_path):
