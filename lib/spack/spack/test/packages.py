...
class TestPackage(object):
    ...
    def test_content_hash_all_same_but_patch_contents(self):
        ...
        assert spec1.package.content_hash(content=content1) != spec2.package.content_hash(
            content=content2
        )
    ...
    def test_content_hash_cannot_get_details_from_ast(self):
        ...
        assert spec3.package.content_hash(content=content3) != spec4.package.content_hash(
            content=content4
        )
