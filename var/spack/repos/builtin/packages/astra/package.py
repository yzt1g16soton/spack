...
class Astra(Package):
    ...
    resource(
        name="generator",
        url="http://www.desy.de/~mpyflo/Astra_for_64_Bit_Linux/generator",
    ...
    resource(
        name="postpro",
        url="http://www.desy.de/~mpyflo/Astra_for_64_Bit_Linux/postpro",
    ...
    resource(
        name="fieldplot",
        url="http://www.desy.de/~mpyflo/Astra_for_64_Bit_Linux/fieldplot",
    ...
    resource(
        name="lineplot",
        url="http://www.desy.de/~mpyflo/Astra_for_64_Bit_Linux/lineplot",
    ...
    resource(
        name="pgxwin_server",
        url="http://www.desy.de/~mpyflo/Astra_for_64_Bit_Linux/pgxwin_server",
        sha256="d2d5702be9cb3d96391c6a0ca37366d580ced1f0f722fb33a6039ad7fd43b69a",
        expand=False,
        when="+gui",
