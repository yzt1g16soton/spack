...
class Hpctoolkit(AutotoolsPackage):
    ...
    conflicts(
        "%gcc@:4.7.99", when="^dyninst@10.0.0:", msg="hpctoolkit requires gnu gcc 4.8.x or later"
    )

    conflicts(
        "%gcc@:4.99.99", when="@2020.03:2020.99", msg="hpctoolkit requires gnu gcc 5.x or later"
    )

    conflicts("%gcc@:6.99.99", when="@2021.00:", msg="hpctoolkit requires gnu gcc 7.x or later")
