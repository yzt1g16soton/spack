...
class QuantumEspresso(Package):
    ...
    conflicts(
        "@6.4+patch",
        when="+qmcpack",
        msg="QE-to-QMCPACK wave function converter requires " "deactivatation of upstream patches",
    )
    conflicts(
    ...
    conflicts(
        "hdf5=none", when="+qmcpack", msg="QE-to-QMCPACK wave function converter requires HDF5"
    )
