...
class Bohrium(CMakePackage, CudaPackage):
    ...
    def cmake_args(self):
        ...
        if "+cuda" in spec and len(cuda_arch) >= 1 and cuda_arch[0]:
            ...
            #      via Spack works.
            raise InstallError("Bohrium does not support setting the CUDA architecture yet.")
    ...
    def check_install(self):
        ...
        pythonpaths.append(join_path(self.prefix, spec["python"].package.site_packages_dir))
