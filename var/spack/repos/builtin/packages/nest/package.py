...
class Nest(CMakePackage):
    ...
    conflicts("~gsl", when="@:2.10.99", msg="Option only introduced for non-ancient versions.")
    conflicts("~shared", when="@:2.10.99", msg="Option only introduced for non-ancient versions.")
    conflicts("~openmp", when="@:2.10.99", msg="Option only introduced for non-ancient versions.")
