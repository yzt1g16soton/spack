...
class Openspeedshop(CMakePackage):
    ...
    depends_on(
        "cbtf-krell@1.9.3:9999+mpich", when="@2.4.0:9999+mpich", type=("build", "link", "run")
    )
    ...
    depends_on(
        "cbtf-krell@develop+mvapich", when="@develop+mvapich", type=("build", "link", "run")
    )
    depends_on(
        "cbtf-krell@1.9.3:9999+mvapich", when="@2.4.0:9999+mvapich", type=("build", "link", "run")
    )
