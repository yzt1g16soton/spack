...
class CbtfKrell(CMakePackage):
    ...
    variant(
        "mvapich", default=False, description="Build mpi experiment collector for mvapich MPI."
    )
    variant("mpich2", default=False, description="Build mpi experiment collector for mpich2 MPI.")
    variant("mpich", default=False, description="Build mpi experiment collector for mpich MPI.")
    variant(
