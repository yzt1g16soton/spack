...
class PyTensorboardPluginWit(Package):
    ...
    def setup(self, spec, prefix):
        ...
        filter_file(
            r"pip install .*", "", "tensorboard_plugin_wit/pip_package/build_pip_package.sh"
        )
        filter_file(
            r"command \-v .*", "", "tensorboard_plugin_wit/pip_package/build_pip_package.sh"
        )
        filter_file(
            r"virtualenv venv", "", "tensorboard_plugin_wit/pip_package/build_pip_package.sh"
        )
        filter_file(
            "unset PYTHON_HOME",
