...
class DocbookXsl(Package):
    ...
    def config_docbook(self):
        ...
        xmlcatalog(
            "--noout", "--add", "system", "http://www.w3.org/2001/xml.xsd", xml_xsd, catalog
        )
        xmlcatalog(
            "--noout", "--add", "system", "http://www.w3.org/2009/01/xml.xsd", xml_xsd, catalog
        )
        xmlcatalog("--noout", "--add", "uri", "http://www.w3.org/2001/xml.xsd", xml_xsd, catalog)
        xmlcatalog(
            "--noout", "--add", "uri", "http://www.w3.org/2009/01/xml.xsd", xml_xsd, catalog
        )
